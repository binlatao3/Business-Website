<?php
    ...
    $start = ($page -1 ) * $limit;
    $donnop = [];
    $alertnop = isset($_GET['checkn'])? $_GET['checkn']:0;

    if(mysqli_query($conn,"SELECT * from ngaynghi where username = '".$_SESSION['username']."' ORDER BY id_nn DESC LIMIT $start, $limit"))
    {
        $count= mysqli_query($conn,"SELECT * from ngaynghi where username = '".$_SESSION['username']."' ORDER BY id_nn DESC LIMIT $start, $limit");
    ...
    $count= mysqli_query($conn,"SELECT count(*) as total from ngaynghi where username = '".$_SESSION['username']."'");
...
<body>
                ...
                <div class="user-list">
                    <?php if($alertnop)
                        {
                            ...
                            <strong>Thành công!</strong>  Nộp đơn thành công thành công!   
                    ...
                    <div class="list-header">
                        <div class="header-title">
                            <h4>Danh sách đơn xin nghỉ phép</h4>
                        </div>
                    </div>
                            ...
                            <div class="list-management-user">
                                <table class="user-table">
                                    <tr class="title-table">
                                        <th class="dis-bl-mobile">Người duyệt</th>
                                        <th>Ngày nộp</th>
                                    ...
                                    <tr class="title-content">
                                        <td class="dis-bl-mobile"><?=user($don['nguoiphanhoi'])['fullname']?></td>
                                        ...
                                        <td class="see-edit-delete">
                                            <a  class="link-see bd-rd-rem" onclick='showModalNopdon(<?php echo $param?>,<?php echo $fullname?>)'>
                            ...
                            <ul class="list-user-page">
                                <div>
                                    ...
                                    <a <?php if($page == 1)
                                                ...
                                                echo "href=./listngaynghi.php?page=1";               
                                        ?>>
                                    ...
                                    <li class="arrow-back-list-user">
                                        <a <?php if($previous<1)
                                                ...
                                                echo "href=./listngaynghi.php?page=".$previous;  
                                        ?>>
                                    ...
                                    <a <?php 
                                            echo "href=./listngaynghi.php?page=".$i;
                                        ?>>
                                        <div>
                                             <?= $i; ?>
                                        </div>
                                    ...
                                    <li class="number-page-list-user">
                                    <a <?php 
                                            echo "href=./listngaynghi.php?page=".$i."&last=".$page;  
                                        ?>>
                                        <div>
                                             <?= $i; ?>
                                        </div>
                                    ...
                                    <a <?php if($next>$pages)
                                                ...
                                                echo "href=./listngaynghi.php?page=".$next;               
                                        ?>>
                                    ...
                                    <a <?php if($page == $pages  || $pages==0)
                                                ...
                                                echo "href=./listngaynghi.php?page=".$pages;               
                                        ?>>
    ...
    <div class="modal-delete-user js-modal-delete-donnop">
        <div class="modal-delete  min-wid">
            <div class="modal-close-edit" onclick="closeModalDonnop()">
            ...
            <div id = "showfile" class="infor-dayoff dayoff-link" style="display:none">
                <label>Đính kèm:</label>
                <a id='downdonlist'><span id = "dinhkem"></span></a>
            </div>
        </div>
    </div>
